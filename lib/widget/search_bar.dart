...
class SearchBar extends StatefulWidget {
  ...
  final void Function() inputBoxClick; //点击文本框回调
...
class _SearchBarState extends State<SearchBar> {
  ...
  //TextEditingController动态设置搜索框的内容
  ...
  Widget get _inputBox {
    ...
    if (widget.searchBarType == SearchBarType.home) {
      ...
      inputBoxColor = Color(int.parse('0xffEDEDED'));//Color(int.parse('0xffEDEDED'))可以直接赋值颜色
    }
    return Container(
      height: 30,
